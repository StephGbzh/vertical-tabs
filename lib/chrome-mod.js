...
//const ChromeModManager = mix(
  ...
  constructor: function PageModRegistry() {
      observerService.addObserver(myObserver, "chrome-document-global-created", false);
    /*observers.add(
  ...
  _destructor: function _destructor() {
      observerService.removeObserver(myObserver, "chrome-document-global-created");
    /*observers.remove(
      "chrome-document-global-created", 
